...
@section("content")
            ...
            <div class="card card-border-shadow-primary h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                        ...
                        <h4 class="ms-1 mb-0">{{ isset($suppliers) ? $suppliers->count() : "0" }}</h4>
                    </div>
                    <p class="mb-1">Onboarded Suppliers</p>
                    {{-- <p class="mb-0">
            ...
            <div class="card card-border-shadow-warning h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                        ...
                        <h4 class="ms-1 mb-0">{{ isset($customers) ? $customers->count() : "0" }}</h4>
                    </div>
                    <p class="mb-1">Onboarded Customers</p>
                    {{-- <p class="mb-0">
        ...
        <div class="col-sm-6 col-lg-3 mb-4">
            <div class="card card-border-shadow-success h-100">
                <div class="card-body">
                    ...
                    <p class="mb-1">Onboarded Vehicles</p>
                    {{-- <p class="mb-0">
        ...
        <div class="col-sm-6 col-lg-3 mb-4">
            <div class="card card-border-shadow-info h-100">
                <div class="card-body">
                    ...
                    <p class="mb-1">Onboarded Drivers</p>
                    {{-- <p class="mb-0">
    ...
    <div class="row">
        <div class="col-md-8 col-xxl-6 col-12 mb-4 order-0 ">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="card-title mb-0">
                        <h5 class="m-0 me-2">Trips Overview</h5>
                        {{-- <small class="text-muted">10th trips created in last 7 days</small> --}}
                    </div>
                </div>
            ...
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between pb-0">
                    <div class="card-title mb-0 pb-3">
                        ...
                        <h5 class="me-2">Customer Wise Active Tours</h5>
                        <p class="card-subtitle text-success"><span>
                                <i class="bx bxs-truck mb-1"></i> total tours 16</span></p>
                    </div>
                </div>
                <div class="card-body">
                    <ul class="p-0 m-0 overflow-auto" style="max-height: 400px;">
                        @if ($tours)
                            @foreach ($tours as $item)
                                <li class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                            <a href="#" class="text-heading text-primary text-truncate fw-medium">
                                                <h6 class="mb-0 text-primary">{{ $item->customer_name ?? "" }}</h6>
                                            </a>
                                            <small>{{ $item->customer_code ?? "" }}</small>
                                        </div>
                                        <div class="user-progress px-3">
                                            <h6 class="mb-0">{{ $item->total_tours ?? "" }} Tours</h6>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
