...
public abstract class BaseDrawerActivity extends AppCompatActivity
    ...
    protected void setupNavigationDrawer() {
        if (navigationView != null) {
            ...
            String finalText = savedUserName + " (" + builder + ")";
            tvUserName.setText(finalText);

            Log.d(TAG, "Drawer header set: " + finalText);
        }
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_sync) {
            ...
            Log.d(TAG, "Global sync clicked");

            // Trigger global sync
            SyncManager.triggerSync(this);

            // Refresh current screen immediately (if overridden)
            onSyncClicked();
    ...
    /**
     * Child activities can override this to refresh immediately
     * Example:
     *  - ProductsActivity → syncAllData()
     *  - InventoryActivity → loadInventory()
     */
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_dashboard) {
            ...
            navigateTo(TagMappingActivity.class);

        } else if (id == R.id.items_inventory) {
            navigateTo(InventoryActivity.class);

        }else if (id == R.id.stock_audit) {
            navigateTo(StockAuditActivity.class);
