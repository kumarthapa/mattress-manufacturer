...
public interface ApiService {
    ...
    @GET("assets/all-details")
    Call<Map<String, Object>> getAllAssetDetails();

    @POST("assets/audit")
    Call<Map<String, Object>> auditAssets(@Body Map<String, Object> payload);
    /*--------------------------------------------------
     *  ASSET RFID UPDATE
     *--------------------------------------------------*/
    @POST("assets/update-rfid")
    Call<Map<String, Object>> updateRfid(@Body Map<String, Object> payload);

    @POST("audit/public-store")
    Call<Map<String, Object>> assetsAudit(@Body List<Map<String, Object>> payload);
