...
import com.treewalker.rfidapp.databinding.ActivityInventoryBinding;
        ...
        call.enqueue(new Callback<Map<String, Object>>() {
            ...
            public void onResponse(Call<Map<String, Object>> call, Response<Map<String, Object>> response) {
                ...
                if (!anySuccess && anyFailure) {
                    ...
                    final String message = (serverMessage != null && !serverMessage.trim().isEmpty())
                            ? serverMessage
                            : "All tags failed.";

                    runOnUiThreadSafe(() ->
                            Snackbar.make(binding.scannedTagsRecycler, message, Snackbar.LENGTH_LONG).show()
                    );
