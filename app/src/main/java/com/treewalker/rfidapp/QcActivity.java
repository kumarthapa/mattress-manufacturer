...
public class QcActivity extends BaseDrawerActivity {

    private androidx.appcompat.widget.AppCompatSpinner qcProductSpinner;
    private LinearLayout qcChecklistContainer, qcItemsLayout;
    private MaterialButton approveQCBtn, rejectQCBtn;

    // Sample products and QC items (replace with real data source)
    private String[] products = {
            "Select Product for QC",
    ...
    protected int getLayoutResourceId() {
        // This layout must include DrawerLayout, Toolbar, and NavigationView with correct IDs
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        approveQCBtn.setOnClickListener(v -> {
            if (isChecklistApproved()) {
                ...
                Toast.makeText(QcActivity.this, "Please complete all required QC checks",
