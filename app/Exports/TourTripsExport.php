...
class TourTripsExport implements FromArray, WithCustomStartCell, WithStyles
{
    protected $data;
    protected $tourData;
    ...
    public function array(): array
    {
        ...
        $exportData = [
            ...
            ["Customer Location :  {$this->tourData['customer_location']}"],
            ["Tour ID  :  {$this->tourData['tour_id']}"],
            [""],
