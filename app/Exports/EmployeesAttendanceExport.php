...
class EmployeesAttendanceExport implements FromArray, WithCustomStartCell, WithStyles
{
    protected $data;
    protected $tourData;
    ...
    public function __construct(array $data, array $empData, array $headers)
    {
        $this->data = $data;
    ...
    {
      // Log::info("empData ---> ".json_encode($this->empData));
        // Start with the employee data
        $exportData = [

            ["Date Range  :  {$this->empData['date_range']}"],
            ...
            // ["Customer Location :  {$this->empData['customer_location']}"],
            // ["Tour ID  :  {$this->empData['tour_id']}"],
            [""],
