...
class MenuServiceProvider extends ServiceProvider
{
  ...
  {
    // Fetch all active menu modules marked as menu items
    ...
    // Normalize parent_module_id: convert empty or null to 0 to mark root items
    ...
    // Build the hierarchical tree with sorting by 'sort' integer
