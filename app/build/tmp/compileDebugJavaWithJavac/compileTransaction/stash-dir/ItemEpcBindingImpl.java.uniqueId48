...
public class ItemEpcBindingImpl extends ItemEpcBinding implements com.treewalker.rfidapp.generated.callback.OnClickListener.Listener {
    ...
    private ItemEpcBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new com.treewalker.rfidapp.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.treewalker.rfidapp.InventoryFragment.HandlerClick) variable);
        }
    ...
    public void setHandler(@Nullable com.treewalker.rfidapp.InventoryFragment.HandlerClick Handler) {
    ...
    protected void executeBindings() {
        ...
        com.treewalker.rfidapp.InventoryFragment.HandlerClick handler = mHandler;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        com.treewalker.rfidapp.InventoryFragment.HandlerClick handlerOnTagClickEpcId = null;
        // handler != null
