...
public class ActivityInventoryBindingImpl extends ActivityInventoryBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.locationLayout, 3);
        sViewsWithIds.put(R.id.locationDropdown, 4);
        sViewsWithIds.put(R.id.startScanBtn, 5);
        sViewsWithIds.put(R.id.scanProgress, 6);
        sViewsWithIds.put(R.id.scanStatusText, 7);
        sViewsWithIds.put(R.id.modeSwitch, 8);
        sViewsWithIds.put(R.id.scannedTagsRecycler, 9);
        sViewsWithIds.put(R.id.tvScannedCount, 10);
        sViewsWithIds.put(R.id.clearTagsBtn, 11);
        sViewsWithIds.put(R.id.updateAuditBtn, 12);
