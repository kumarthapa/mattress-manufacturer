...
public class ActivityScannerBindingImpl extends ActivityScannerBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.modeSwitch, 6);
        sViewsWithIds.put(R.id.productSelect, 7);
        sViewsWithIds.put(R.id.scannedTagsRecycler, 8);
        sViewsWithIds.put(R.id.tvScannedCount, 9);
        sViewsWithIds.put(R.id.clearTagsBtn, 10);
        sViewsWithIds.put(R.id.mapTagsBtn, 11);
    ...
    public ActivityScannerBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private ActivityScannerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
