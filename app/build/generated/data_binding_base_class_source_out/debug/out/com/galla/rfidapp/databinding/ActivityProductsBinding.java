...
public final class ActivityProductsBinding implements ViewBinding {
  ...
  private ActivityProductsBinding(@NonNull DrawerLayout rootView,
      ...
      @NonNull TextInputEditText searchInput, @NonNull SwipeRefreshLayout swipeRefresh,
      @NonNull MaterialToolbar toolbar, @NonNull MaterialTextView tvActiveProducts,
      @NonNull TextView tvNoResults, @NonNull MaterialTextView tvPassedProducts) {
  ...
  public static ActivityProductsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProductsBinding((DrawerLayout) rootView, drawerLayout, navView,
          productsRecyclerView, refreshProducts, searchInput, swipeRefresh, toolbar,
