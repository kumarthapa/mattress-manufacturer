...
public final class ActivityLauncherBinding implements ViewBinding {
  ...
  public static ActivityLauncherBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.launchLogo;
      ImageView launchLogo = ViewBindings.findChildViewById(rootView, id);
      if (launchLogo == null) {
        break missingId;
      }

      return new ActivityLauncherBinding((ConstraintLayout) rootView, launchLogo);
    }
